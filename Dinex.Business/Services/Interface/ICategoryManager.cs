namespace Dinex.Business
{
    public interface ICategoryManager
    {
        ...
        Task<CategoryResponseDto> CreateAsync(CategoryRequestDto request, Guid userId, string applicable);
        ...
        Task<List<CategoryResponseDto>> ListCategoriesAsync(Guid userId, bool isToListDeleted);
    }
}
